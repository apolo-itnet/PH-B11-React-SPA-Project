  ...
  return (
    ...
    <div className="blog-container px-20 ">
     ...
     <div className="main-container flex px-20 my-2 mx-auto gap-2">
      <div className="left-container p-4 mx-auto items-center min-w-8/12 border-2 border-amber-400 rounded-2xl">
       <Blogs handleBookmark={handleBookmark} handleMarkAsRead={handleMarkAsRead} className="blog-container px-10 m-4"></Blogs>
      </div>
